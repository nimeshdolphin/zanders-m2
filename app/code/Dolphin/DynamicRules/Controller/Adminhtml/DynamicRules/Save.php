...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Dolphin\DynamicRules\Model\DynamicRules::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccessMessage(__('You saved the Dynamicrules.'));
                $this->dataPersistor->clear('dolphin_dynamicrules_dynamicrules');
