...
class Save extends \Zanders\CategoryCode\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $imagePath = 'zanders/categorycode'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('zanders_categorycode/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('zanders_categorycode/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('zanders_categorycode/*/new');
                }
                return;
            } catch (\Exception $e) {
