 ...
 * Class DataProvider
 */
class TopPromoDataProvider extends \Magento\Ui\DataProvider\ModifierPoolDataProvider
{
    /**
     * @var \Zanders\Promotion\Model\ResourceModel\TopPromo\Collection
     */
    ...
    public function getData()
    {
        ...
        foreach ($items as $topPromo) {
            $this->loadedData[$topPromo->getId()] = $topPromo->getData();
        }
        return $this->loadedData;
    }
}
