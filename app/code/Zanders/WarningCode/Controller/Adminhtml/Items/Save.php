...
class Save extends \Zanders\WarningCode\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('zanders/warningcode');
                        ...
                        $imagePath = 'zanders/warningcode'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('zanders_warningcode/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('zanders_warningcode/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('zanders_warningcode/*/new');
                }
                return;
            } catch (\Exception $e) {
